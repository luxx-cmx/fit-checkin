...
export default function GoalsPage() {
    ...
    const save = async () => {
        if (!validate()) return
        const profile = getProfile()
        saveProfile({ ...profile, goalType: goals.goal_type, goal_type: goals.goal_type, dailyCalories: goals.calorie_target, dailyWater: goals.water_target, dailySteps: goals.steps_target, dailySleep: goals.sleep_target, dailyExercise: goals.exercise_target })
